...
public class DigitalVideoDisc extends Disc implements Playable {
	...
	public DigitalVideoDisc(String title, String category, String director, int length, float cost, LocalDate date) throws IllegalArgumentException {
		super(title,category,director,length,cost,date);
		this.dateAdded = date;
	}
	
	public DigitalVideoDisc(String title, String category, String director, int length, float cost) throws IllegalArgumentException {
